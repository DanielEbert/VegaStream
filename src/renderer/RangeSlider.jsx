...
import { convertMilliseconds } from './util.js';
...
class RangeSlider extends PureComponent {
  constructor() {
    ...
    this.thumbValue = [createRef(), createRef()];
  ...
  updateThumbs() {
    ...
    this.thumbValue[0].current.innerHTML = convertMilliseconds(this.value.min);
    this.thumbValue[1].current.innerHTML = convertMilliseconds(this.value.max);
  }
  ...
  updateRange() {
    ...
    const deltaOffset =
      ((0.0 - (this.value.min - this.options.min) / this.maxRangeWidth) *
    ...
    const deltaDimension =
      ((1 - (this.value.max - this.options.min) / this.maxRangeWidth) *
  ...
  render() {
    ...
    this.fallbackToDefault('defaultValue', [2500, 7500]);
    ...
    this.fallbackToDefault('max', 100000);
    if (this.props.value) {
      this.fallbackToDefault('value', [2500, 7500]);
    }
    ...
    return (
      <div
        ...
        id={this.props.id}
        ref={this.element}
        className={'group ' + clsx('range-slider', this.props.className)}
      >
        <input
          ref={this.input[0]}
          type="range"
        ...
        <div className="hidden group-hover:block group-active:block">
          <div
            ref={this.thumb[0]}
            role="slider"
            className="range-slider__thumb justify-center flex"
            data-lower
          >
            <div ref={this.thumbValue[0]} className="absolute -inset-y-7 z-50">
              {this.props.value
                ? this.options.value[0]
                : this.isComponentMounted
                ? this.value.min
          ...
          <div
            ref={this.thumb[1]}
            role="slider"
            className="range-slider__thumb flex justify-center"
            data-upper
          >
            <div ref={this.thumbValue[1]} className="absolute -inset-y-7 z-50">
              {this.props.value
                ? this.options.value[1]
                : this.isComponentMounted
                ? this.value.min
